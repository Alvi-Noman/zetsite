...
import { ProductHero, productHeroSchema } from './sections/ProductHero.js';
import { FeatureCards, featureCardsSchema } from './sections/FeatureCards.js';
import { ChecklistFeatures, checklistFeaturesSchema } from './sections/ChecklistFeatures.js';
...
import { FeatureCard, featureCardSchema } from './blocks/FeatureCard.js';
import { ChecklistItem, checklistItemSchema } from './blocks/ChecklistItem.js';

export const adFunnelTheme: Theme = {
  id: 'ad-funnel',
  name: 'Ad Funnel',
  sections: createSectionRegistry([
    { schema: headerSchema, Component: Header },
    { schema: heroSchema, Component: Hero },
    { schema: productHeroSchema, Component: ProductHero },
    { schema: featureCardsSchema, Component: FeatureCards },
    { schema: checklistFeaturesSchema, Component: ChecklistFeatures },
  ...
  blocks: createSectionRegistry([
    ...
    { schema: featureCardSchema, Component: FeatureCard },
    { schema: checklistItemSchema, Component: ChecklistItem },
  ]),
  globalSettingsSchema: [
    { key: 'colors.primary', type: 'color', label: 'Primary color', default: '#8B5CF6' },
    { key: 'colors.background', type: 'color', label: 'Background', default: '#ffffff' },
    { key: 'colors.text', type: 'color', label: 'Text', default: '#111111' },
    { key: 'colors.accent', type: 'color', label: 'Accent', default: '#EC4899' },
  ],
  defaultGlobalSettings: {
    colors: { primary: '#8B5CF6', background: '#ffffff', text: '#111111', accent: '#EC4899' },
