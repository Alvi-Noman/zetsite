...
export const editorialTheme: Theme = {
  ...
  globalSettingsSchema: [
    ...
    { key: 'colors.background', type: 'color', label: 'Background', default: '#FBFAF8' },
    { key: 'colors.text', type: 'color', label: 'Text', default: '#1C1917' },
    { key: 'colors.accent', type: 'color', label: 'Accent', default: '#065F46' },
  ],
  defaultGlobalSettings: {
    colors: { primary: '#1C1917', background: '#FBFAF8', text: '#1C1917', accent: '#065F46' },
