        ...
        >
          {collections.map((c) => (
            <a
              ...
              className={`flex items-center justify-center rounded-md bg-neutral-100 text-neutral-900 font-medium hover:bg-neutral-200 transition-colors ${aspectClass || 'aspect-[4/3]'}`}
            >
              {c.name}
            </a>
          ))}
