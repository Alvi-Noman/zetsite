...
export function CollectionTemplate({ storeSlug, handle }: CollectionTemplateProps) {
  ...
  if (data === null) {
    return <div className="px-6 py-16 text-center text-neutral-400">Collection not found</div>;
  }
  ...
  return (
    <div className="px-6 py-8 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-10">
        <h1 className="text-3xl font-semibold text-neutral-900">{data.collection.name}</h1>
        <select
          value={sort}
