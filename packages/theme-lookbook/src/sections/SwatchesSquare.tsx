...
export interface SwatchesSquareSettings {
  heading: string;
}

export const swatchesSquareSchema: SectionSchema = {
  type: 'swatchesSquare',
  label: 'Variant swatches (square)',
...
export function SwatchesSquare({ settings, blocks }: SectionComponentProps<SwatchesSquareSettings>) {
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {swatches.map((swatch, i) => (
            <button
              ...
              className={`h-10 w-10 shrink-0 overflow-hidden ring-1 ring-offset-2 transition-all ${
