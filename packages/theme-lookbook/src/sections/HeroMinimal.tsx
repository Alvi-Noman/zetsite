...
export const heroMinimalSchema: SectionSchema = {
  ...
  fields: [
    ...
    { key: 'textColor', type: 'color', label: 'Text color', default: '#1C1917', tab: 'style' },
  ],
  defaultSettings: { imageUrl: '', badgeText: 'New arrival', backgroundColor: '#ffffff', textColor: '#1C1917' },
};

// Deliberately not full-bleed/dominant like the other designs — a small
// modest image keeps this reading as "minimal" while still showing a photo.
