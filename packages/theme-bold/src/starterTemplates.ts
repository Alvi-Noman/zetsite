...
export const starterTemplates: StarterTemplate[] = [
  {
    ...
    name: 'Classic store',
    sections: [
      { type: 'header', settings: { storeName: 'MY STORE', tagline: 'Bold goods, no compromise' }, blocks: HEADER_BLOCKS },
      {
        type: 'hero',
        settings: {},
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'faq', settings: {}, blocks: [heading('Frequently asked questions', 'md'), { type: 'faqItem', settings: {} }] },
