...
export const advertorialTheme: Theme = {
  id: 'advertorial',
  name: 'Advertorial',
  ...
  globalSettingsSchema: [
    { key: 'colors.primary', type: 'color', label: 'Primary color', default: '#111111' },
  ...
  defaultGlobalSettings: {
    colors: { primary: '#111111', background: '#ffffff', text: '#111111', accent: '#dc2626' },
