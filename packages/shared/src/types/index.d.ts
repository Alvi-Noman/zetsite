...
export type SectionAnimation = 'none' | 'fade-in' | 'fade-up' | 'fade-down' | 'fade-left' | 'fade-right' | 'zoom-in' | 'slide-up';
...
export type LandingPageGenerationStatus = 'idle' | 'generating' | 'native' | 'ai-enhanced' | 'ai-partial';
